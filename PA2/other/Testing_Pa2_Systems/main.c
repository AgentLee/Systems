    ...
    while(iter->curr != NULL){
        if(initial ==1){
            ...
            if (item == NULL){
              break;
                ...
                printf("struct={%d} ", ((TestStruct*)(value))->field);
            } 
        ...
        if (item == NULL){
            ...
            if(type == INT){
                ...
                printf("struct={%d} ", ((TestStruct*)(item->value))->field);
            }
        }
    }
    printf("\n");
...
int main(int argc, char*argv[])
{
    ...
    if(choice == 1){
        ...
        *toins = 4;
        ...
        item = SLNextItem(iter);  //prints 5
        printf("%d ", *((int*)item));
        item = SLNextItem(olditer);
        printf("%d ", *((int*)item)); //prints 7
        
        
        iterprint_all_int(s,iter); //prints -1
        
        iterprint_all_int(s,olditer); //prints 5 -1
        ...
        item = SLNextItem(iter);
        int x1 = 6;
        if(SLRemove(s,&x1) && *((int*)SLNextItem(iter)) == 7
        ...
        *x4 = 4;
        ...
        //Add item to head, after iterator has been created
        SortedListPtr s = SLCreate(compareInts,destroyBasicTypeAlloc);
        int iarr[3] = {7,5,3};
        populate_list(s,INT,sizeof(iarr)/sizeof(int),iarr,0,0,NULL);
        ...
        *toinsert = 8;
        ...
        iterprint_all_int(s,iter); //prints 7 5 3
    }else if(choice == 15){
